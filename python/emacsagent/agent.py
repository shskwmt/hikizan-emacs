...
pro_agent = Agent(
    ...
    name='pro_agent',
    description='A powerful sub-agent for complex reasoning and strategic analysis.',
    instruction=PRO_AGENT_SYSTEM_PROMPT,
)
...
root_agent = Agent(
    ...
    tools=[execute_elisp_code],
    sub_agents=[pro_agent],
)
