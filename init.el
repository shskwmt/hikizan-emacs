...
(custom-set-variables
 ...
 '(package-selected-packages
   '(command-log-mode terraform-mode go-mode consult zenburn-theme bind-map corfu orderless vertico yasnippet-snippets yasnippet git-gutter magit which-key evil)))
(custom-set-faces
