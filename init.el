...
(custom-set-variables
 ...
 '(package-selected-packages
   '(popwin yasnippet-snippets yaml-mode which-key vertico terraform-mode orderless nerd-icons-dired nerd-icons-corfu nerd-icons-completion marginalia lsp-ui go-mode git-gutter ellama ein editorconfig dockerfile-mode consult command-log-mode almost-mono-themes ace-window)))
(custom-set-faces
